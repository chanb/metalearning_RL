...
import helper.envs
from helper.policies import GRUPolicy, FCNPolicy, SNAILPolicy
...
parser.add_argument('--policy', type=str, default='gru', help='policy to be used [fcn, gru, snail] (default: gru)')
...
def reinforce(rl_category, num_actions, opt_learning_rate, num_tasks, max_num_traj, max_traj_len, discount_factor,
    ...
    if policy == "gru":
        ...
        policy = FCNPolicy(num_actions)
    elif policy == "snail":
        policy = SNAILPolicy(num_actions, max_num_traj)
