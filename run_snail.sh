...
python rl2_train.py --model_type snail --out_file test_snail.pt --batch_size $batchsize --num_tasks $num_tasks --mini_batch_size $minibatchsize --num_traj $num_traj --tau 0.3 --gamma 0.99 --ppo_epochs $epochs --learning_rate $lr --clip_param $clip_param
