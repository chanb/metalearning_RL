...
python evaluate_model.py --num_tasks $tasks --num_actions 5 --task bandit --eval_model ./saves/rl2/ppo_bandit_5_${traj}_SGD_lr${lr}_numtasks$tasks.pt --eval_tasks ./experiments/bandit_5_$tasks.pkl --outfile sgd_result.pkl --ppo_epochs $eval_ppo_epochs --task bandit --traj_len 1 --num_traj $traj --mini_batch_size $eval_minibatch --learning_rate $lr --batch_size $eval_batchsize --clip_param 0.1
