...
class SNAILActorCritic(nn.Module):
  def __init__(self, output_size, input_size, max_num_traj, max_traj_len, actor_encoders, critic_encoders, actor_encoders_output_size, critic_encoders_output_size, actor_hidden_size=32, critic_hidden_size=16, device):
    ...
    self.actor = SNAILPolicy(output_size, input_size, max_num_traj, max_traj_len, actor_encoders, actor_encoders_output_size, hidden_size=actor_hidden_size, device)

    self.critic = SNAILValue(input_size, max_num_traj, max_traj_len, critic_encoders, critic_encoders_output_size, hidden_size=critic_hidden_size, device)
